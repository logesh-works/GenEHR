...
class Transcriptor:
    ...
    def __init__(self, patient_name,patient_age,dialog_audio,file, log_folder, language, modelSize, ACCESS_TOKEN, voices_folder=None, quantization=False):
        self.file = file
        ...
        self.dialog_audio = dialog_audio
    def nemo(self):
        res = core_analysis(self.patient_name,self.patient_age,self.dialog_audio,self.file, self.voices_folder, self.log_folder, self.language, self.modelSize, self.ACCESS_TOKEN, "nemo", self.quantization)
        return res
